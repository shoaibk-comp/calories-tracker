var app = angular.module('caloriesCounterApp', ['editableTableWidgets', 'frontendServices'])

app.filter('excludeDeleted', function () {
...
app.controller('CaloriesTrackerCtrl', ['$scope', 'MealService', 'UserService', '$timeout',
    function ($scope, MealService, UserService, $timeout) {
        ...
        $scope.selectionChanged = function () {
            $scope.vm.isSelectionEmpty = _.some($scope.vm.meals, function (meal) {
