...
require.config({
    paths: {
        ...
        jQuery: "../bower_components/jquery/dist/jquery", // needed only by the date time picker
        datetimepicker: '../bower_components/jquery-datetimepicker/jquery.datetimepicker',
